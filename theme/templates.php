                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul class="contact-details">
                                        <li><a href="#"><i class="fa fa-phone"></i> 09167347823</a>
                                        </li>
                                        <li><a href="#"><i class="fa fa-envelope-o"></i> fpb@library.com</a>
                                        </li> 
                                    </ul>
                                    <!-- End Contact Info -->
                                </div><!-- .col-md-6 -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="footer-address">
                            <ul>
                                <li class="footer-contact"><i class="fa fa-home"></i>FEDERAL POLYTECHNIC BIDA</li>
                                <li class="footer-contact"><i class="fa fa-envelope"></i><a href="#">victorogbu@fpb.com</a></li>
                                <li class="footer-contact"><i class="fa fa-phone"></i>08123647832</li>
                                <li class="footer-contact"><i class="fa fa-globe"></i><a href="#" target="_blank">www.federalpolytechnicbida.com</a></li>
                            </ul>
                        </div>
                    </div><!--/.col-md-3 -->
                    <div class="col-md-4">
